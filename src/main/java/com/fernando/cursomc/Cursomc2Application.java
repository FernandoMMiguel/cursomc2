...
public class Cursomc2Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "3637893488", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("27343453", "938383983"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Av. Matos", "105", "Sala 800", "Centro", "3782943", cli1, c2);
